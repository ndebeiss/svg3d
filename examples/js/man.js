    	...
    	function rotate(id) {
    		...
    		var yTranslate = 3100;
    		shapeCloned.transform([svg3d.MATRIX.makeScale(1, 1, 0.2), svg3d.setTranslationMatrix(0, yTranslate, 0) , svg3d.MATRIX.makeRotationX(-Math.PI/2), svg3d.setTranslationMatrix(0, -yTranslate, 0)]);
